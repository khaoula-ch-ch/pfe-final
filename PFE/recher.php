...
$sql = "SELECT * FROM `courrierarrive` WHERE envoyerpar = '$str' OR ref='$str' OR distination='$str' OR sousdistination='$str' OR objet='$str' AND (distination = '$acc_name' OR sousdistination  = '$acc_name' OR envoyerpar = '$acc_name' )";
